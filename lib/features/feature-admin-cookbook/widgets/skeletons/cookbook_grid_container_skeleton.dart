...
/// Full-grid animated skeleton for the cookbook screen.
/// A single [AnimationController] drives all cards — they all pulse in sync.
class CookbookGridContainerSkeleton extends StatefulWidget {
  const CookbookGridContainerSkeleton({super.key});

  @override
  State<CookbookGridContainerSkeleton> createState() =>
      _CookbookGridContainerSkeletonState();
}

class _CookbookGridContainerSkeletonState
    extends State<CookbookGridContainerSkeleton>
